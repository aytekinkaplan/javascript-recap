Elbette, örnekleri çoğaltarak her bir durumu daha detaylı açıklayayım:
...
1. **If-Else Statements**: Çeşitli durumları kontrol ederek, farklı sonuçları gösterir.
2. **Switch-Case Statements**: Özellikle çoklu durumu karşılaştırmada kullanılır.
3. **Ternary Operators**: Tek satırlık koşullu ifadeler oluşturmak için kullanılır.
4. **Logical Operators**: `&&` ve `||` operatörleri ile birden fazla durumu kontrol eder.
5. **Nested Conditions**: İç içe koşullar ile daha detaylı kontrol sağlar.

Her bir örnek, JavaScript'teki koşullu ifadelerin ve operatörlerin kullanımını detaylı bir şekilde gösteriyor. Başka bir örnek veya açıklama istersen lütfen belirt.
